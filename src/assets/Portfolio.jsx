...
>
  ...
  <div className="max-w-3xl flex flex-col items-center space-y-6">
    ...
    <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} text-lg leading-relaxed px-4`}>
      ...
      <motion.section
        id="Proyectos"
        className="h-screen flex flex-col items-center justify-center bg-gray-50 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.3, duration: 1 }}
      >
        <h2 className="text-[#111418] text-3xl font-bold mb-8">Proyectos Destacados</h2>
      ...
      <motion.section
        ...
        transition={{ delay: 0.3, duration: 1 }}
      >
        <h2 className="text-[#111418] text-3xl font-bold mb-8">Habilidades</h2>
        <div className="max-w-5xl grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {[
            ...
            { icon: <FaMoon size={50} className="text-gray-400" />, name: 'PostgreSQL' },
          ].map((skill, index) => (
            <motion.div
              key={index}
